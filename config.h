...
static Key keys[] = {
	...
	{ MODKEY,			XK_d,		spawn,          SHCMD("rofi -display-drun 'Fire up' -theme ~/.config/rofi/theme.rasi -show drun") },
	...
	{ MODKEY|ShiftMask,		XK_period,	spawn,		SHCMD("playerctl play-pause") },
	{ MODKEY|ShiftMask,		XK_slash,	spawn,		SHCMD("playerctl next") },
	...
	{ 0, XF86XK_ScreenSaver,	spawn,		SHCMD("i3lock-fancy & xset dpms force off; mpc pause; pauseallmpv") },
